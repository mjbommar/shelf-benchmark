...
dataset_info:
  features:
    ...
    - name: target_word_range
      sequence: int32
{generation_metadata_yaml}  splits:
    - name: train
...
- **v{version}** ({date}): Pre-release for benchmark testing with {total_documents:,} documents
...
"""
    ...
    def generate_yaml_header(self) -> str:
        ...
        return YAML_TEMPLATE.format(
            ...
            generation_metadata_yaml=self._get_generation_metadata_yaml(),
        )
