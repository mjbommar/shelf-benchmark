...
class Archetype(BaseModel):
    ...
    geographic: list[str] = Field(default_factory=list, description="Likely geographic areas")
    ...
    title_patterns: list[str] = Field(
        ...
        description="Example title patterns for generation"
    )
...
ARCHETYPES: list[Archetype] = [
    Archetype(
        ...
        topics=[
            "Geology", "Soils", "Land use", "Groundwater", "Mineral resources",
            "Coal", "Water-supply", "Geology, Stratigraphic", "Hydrology",
        ],
        geographic=["United States", "California", "Colorado", "Montana", "Wyoming", "Alaska"],
        weight=0.12,
        title_patterns=[
    ...
    Archetype(
        ...
        topics=[
            "Population", "Housing", "Manufactures", "Retail trade", "Agriculture",
            "Wholesale trade", "Service industries", "Construction industry",
    ...
    Archetype(
        ...
        lcc_name="Law",
        topics=[
            "National security", "Terrorism", "Veterans", "Medicare",
            "Social security", "Immigration", "Budget", "Taxation",
    ...
    Archetype(
        ...
        topics=[
            "Guided missiles", "Military equipment", "Airplanes, Military",
            "Weapons systems", "Military operations", "Logistics",
        ],
        geographic=["United States"],
        weight=0.08,
        title_patterns=[
    ...
    Archetype(
        ...
        topics=[
            "Agriculture", "Crops", "Livestock", "Farm income", "Forests and forestry",
            "Soil conservation", "Food supply", "Agricultural prices",
        ],
    ...
    Archetype(
        ...
        lcc_name="Medicine",
        topics=[
            "Public health", "Vital statistics", "Mortality", "Diseases",
            "Health services", "Medicare", "Medicaid", "Hospitals",
        ],
        geographic=["United States"],
        weight=0.08,
        title_patterns=[
    ...
    Archetype(
        ...
        lcc_name="Technology",
        topics=[
            "Pollution", "Water quality", "Air quality", "Hazardous wastes",
            "Environmental protection", "Water--Pollution", "Drinking water",
        ],
        geographic=["United States"],
        weight=0.06,
        title_patterns=[
    ...
    Archetype(
        ...
        lcc_name="Technology",
        topics=[
            "Aeronautics", "Space flight", "Astronautics", "Rockets",
            "Satellites", "Space vehicles", "Aerospace engineering",
        ],
        geographic=["United States"],
        weight=0.06,
        title_patterns=[
    ...
    Archetype(
        ...
        lcc_name="Education",
        topics=[
            "Education", "Schools", "Students", "Teachers", "Higher education",
            "Educational tests", "Literacy", "School enrollment",
        ],
        geographic=["United States"],
        weight=0.05,
        title_patterns=[
    ...
    Archetype(
        ...
        topics=[
            "Government publications", "Bibliography", "Library resources",
    ...
    Archetype(
        ...
        lcc_name="Social Sciences",
        topics=[
            "Wages", "Employment", "Labor supply", "Occupations",
            "Cost of living", "Prices", "Unemployment",
        ],
        geographic=["United States"],
        weight=0.05,
        title_patterns=[
    ...
    Archetype(
        ...
        lcc_name="Social Sciences",
        topics=[
            "Auditing", "Government spending", "Program evaluation",
            "Administrative agencies", "Government accountability",
        ],
        geographic=["United States"],
        weight=0.05,
        title_patterns=[
    ...
    Archetype(
        ...
        lcc_name="Social Sciences",
        topics=[
            "Transportation", "Highways", "Railroads", "Aviation",
            "Traffic safety", "Automobiles", "Shipping",
        ],
        geographic=["United States"],
        weight=0.04,
        title_patterns=[
    ...
    Archetype(
        ...
        lcc_name="Technology",
        topics=[
            "Energy", "Petroleum", "Natural gas", "Coal", "Nuclear energy",
            "Renewable energy", "Electric power", "Energy consumption",
        ],
        geographic=["United States"],
        weight=0.04,
        title_patterns=[
